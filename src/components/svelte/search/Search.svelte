<script lang="ts">
  ...
  import BuildingTypeFilterBar from "../BuildingTypeFilterBar.svelte";
  import MapChromeToggleButton from "../map-chrome/MapChromeToggleButton.svelte";
  import MapChromeToggleIcon from "../map-chrome/MapChromeToggleIcon.svelte";
