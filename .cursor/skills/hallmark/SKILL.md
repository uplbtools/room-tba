---
name: hallmark
description: "Anti-AI-slop design skill for greenfield pages, audits, redesigns, and design extraction from URLs or screenshots. Use when the user asks to build a new app or landing page, wants to redesign something, invokes Hallmark by name, or uses audit/redesign/study. Room TBA: also read references/room-tba.md before map chrome, sidebar, or editor UI work."
version: 1.1.0
---

# Hallmark

**Room TBA:** this repo vendors Hallmark under `.cursor/skills/hallmark/`. Before auditing or redesigning map chrome, side panel, landing, or editor surfaces, read [`references/room-tba.md`](references/room-tba.md) for product-specific constraints (calm UI, 320px, maroon brand, Entry zones).
