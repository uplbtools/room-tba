...
Optional env vars (R2 uploads, Supabase Auth client): see [`.env.example`](.env.example). Production DB backups: nightly GitHub Actions workflow + [database backup runbook](docs/database-backup-runbook.md).
